...
class AdapterDetail(private val weatherDataArray: ArrayList<WeatherData>) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val textTemp: TextView = itemView.findViewById(R.id.temp)
        val imageWeather: ImageView = itemView.findViewById(R.id.ImageWeather)
        val nameImgWeather: TextView = itemView.findViewById(R.id.nameImgWeather)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = LayoutInflater.from(parent.context).inflate(R.layout.card_weather_detail, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textTemp.text = weatherData.temperature
        weatherImageMap[weatherData.weatherImg]?.let { holder.imageWeather.setImageResource(it) }
        holder.nameImgWeather.text = weatherData.weatherImg
    }
